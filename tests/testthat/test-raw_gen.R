test_that("raw_gen", {
  ...
  set.seed(123)
  testthat::expect_true(round(raw_gen(baboon.parms_df, dist = "log")[1, 6][[1]], 2) == 43.96)
  # univariate truncated distribution
  set.seed(123)
  testthat::expect_true(round(raw_gen(baboon.parms_df, dist = "trunc")[1, 6][[1]], 2) == 45.39)
  ...
  testthat::expect_error(raw_gen(baboon.parms_df, Trait = 500))
